...
const Hero = () => {
  ...
  return (
    <div
      ref={parallaxRef}
      className={`bg-cover bg-center bg-no-repeat bg-fixed flex flex-col sm:bg-['/mview.png'] md:bg-[url('/tab.png')] items-center lg:bg-[url('/bg.png')] justify-center w-full min-h-screen mx-auto my-0 py-6 z-10`}
    >
