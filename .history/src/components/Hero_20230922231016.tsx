...
const Hero = () => {
  ...
  return (
    <div
      ref={parallaxRef}
      className={`bg-cover bg-center bg-no-repeat bg-fixed flex flex-col bg-mview md:bg-tab lg:bg-bg bg-no-repeat bg-cover bg-center" items-center justify-center w-full min-h-screen mx-auto my-0 py-6 z-10`}
    >
